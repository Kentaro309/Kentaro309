 ...
 * Created: Unknown (modified 2024)
 * Description: First-person character controller supporting movement, camera look, sprinting, jumping, crouching, zoom, head-bob, pause handling, and sprint bar UI.
...
public class FirstPersonController : MonoBehaviour
{
	...
	private void HandleRaycast()
	{
		...
		{
			hitObject = hitInfo.collider.gameObject; //add GameObject back if doesn't work
